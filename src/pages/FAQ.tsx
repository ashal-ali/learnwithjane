        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-10">
            <div className="bg-white rounded-lg shadow-md p-8">
              <h3 className="text-xl font-serif font-semibold text-tutor-navy mb-4 leading-tight">What subjects do you tutor?</h3>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <h3 className="text-xl font-serif font-semibold text-tutor-navy mb-4 leading-tight">What is your tutoring philosophy?</h3>
              <div className="text-tutor-gray leading-relaxed">
                <p>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <h3 className="text-xl font-serif font-semibold text-tutor-navy mb-4 leading-tight">What type of college application essays do you edit?</h3>
              <div className="text-tutor-gray leading-relaxed">
                <p>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <h3 className="text-xl font-serif font-semibold text-tutor-navy mb-4 leading-tight">What are your fees?</h3>
              <div className="text-tutor-gray leading-relaxed">
                <p>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <h3 className="text-xl font-serif font-semibold text-tutor-navy mb-4 leading-tight">Where are sessions conducted?</h3>
              <div className="text-tutor-gray leading-relaxed">
                <p>
