          ...
          <div className="grid grid-cols-1 gap-16">
            ...
            <div className="bg-white rounded-lg shadow-md p-8 md:p-12">
              <div className="flex items-center mb-6">
                <div className="bg-tutor-teal bg-opacity-20 p-3 rounded-full mr-4 flex-shrink-0">
                  <Book className="h-8 w-8 text-tutor-teal" />
                </div>
                <h2 className="text-2xl md:text-3xl font-serif font-bold text-tutor-navy leading-tight">English Academic Tutoring</h2>
              </div>
              ...
              <div className="ml-0 md:ml-16 space-y-6 text-tutor-gray">
                ...
                <h3 className="text-xl font-serif font-semibold text-tutor-navy leading-tight">Subjects Covered:</h3>
                ...
                <h3 className="text-xl font-serif font-semibold text-tutor-navy leading-tight">Benefits:</h3>
                <ul className="list-disc ml-6 space-y-2">
                ...
                <div className="mt-8">
                  <Button asChild className="bg-tutor-teal hover:bg-tutor-navy text-white h-11">
            ...
            <div className="bg-white rounded-lg shadow-md p-8 md:p-12">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl md:text-3xl font-serif font-bold text-tutor-navy leading-tight">College Application Essay Editing</h2>
              </div>
              ...
              <div className="ml-0 md:ml-16 space-y-6 text-tutor-gray">
                ...
                <h3 className="text-xl font-serif font-semibold text-tutor-navy leading-tight">Services Include:</h3>
                <ul className="list-disc ml-6 space-y-2">
